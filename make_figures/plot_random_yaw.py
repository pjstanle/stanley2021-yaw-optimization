...
plt.title("random Boolean yaw angles",fontsize=8)
plt.subplots_adjust(top=0.9,left=0.18,right=0.75,bottom=0.15)

# plt.savefig("figures/random_yaw_angle.pdf",transparent=True)
